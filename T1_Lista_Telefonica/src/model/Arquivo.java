...
public abstract class Arquivo {
	...
	public static void AlteraArquivo(String NomeArquivo, String TextoAnt,
			String Texto) throws IOException {

		String arquivo = NomeArquivo;
		String arquivoTmp = NomeArquivo + "temp";
		...
		while ((linha = rw.readLine()) != null) {
			if (linha.contains(TextoAnt)) {
				linha = linha.replace(TextoAnt, Texto);
			}
			bw.write(linha);
			bw.newLine();
		}
	...
	public static Arq LeArquivo(String pNomeArquivo) throws IOException {
		Arq arq = new Arq();
